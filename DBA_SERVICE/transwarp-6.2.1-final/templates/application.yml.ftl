...
spring:
  datasource:
    url: jdbc:h2:file:${service['dbaservice.persistence.datadir']}/${service.sid};DB_CLOSE_ON_EXIT=FALSE;AUTO_RECONNECT=TRUE;MV_STORE=FALSE;CACHE_SIZE=102400;TRACE_LEVEL_FILE=0;UNDO_LOG=0;MAX_QUERY_TIMEOUT=300000;MVCC=TRUE
...
<#if data_persistence_enabled="true">
  data-persistence:
    file-path: ${service['dbaservice.persistence.datadir']}/${service.sid}.h2.db
