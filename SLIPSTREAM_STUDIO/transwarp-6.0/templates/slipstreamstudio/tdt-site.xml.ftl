...
<#if service['javax.jdo.option.ConnectionUrl']??>
    <@property "tdt.inceptor.metastore.mysql.url" service['javax.jdo.option.ConnectionUrl']/>
<#else>
...
<#else>
  ...
  <#if service['tdt.inceptor.auth.mode']??>
    <@property "tdt.inceptor.auth.mode" service['tdt.inceptor.auth.mode']/>
<#else>
    <@property "tdt.inceptor.auth.mode" mode/>
</#if>
