...
export EXTRA_DRIVER_OPTS=" ${dbaServiceExtraDriverOpts + service['EXTRA_DRIVER_OPTS']} -Djava.security.auth.login.config=/etc/${service.sid}/conf/jaas.conf"
...
<#noparse>
EXTRA_EXECUTOR_OPTS+=" -Dngmr.shiva.mastergroup=${SHIVA_MASTER_GROUP} "
</#noparse>
</#if>
