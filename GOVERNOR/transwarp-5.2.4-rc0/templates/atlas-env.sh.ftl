...
export ATLAS_HOME_DIR=/usr/lib/governor

# Where log files are stored. Defatult is logs directory under the base install location
export ATLAS_LOG_DIR=/var/log/${service.sid}
...
export JAVAX_JDO_OPTION_CONNECTION_URL=jdbc:mysql://${hostPorts?join(",")}/governor_${service.sid}
