...
catalog.agent.server.address = https://${service.roles["CATALOG_AGENT"][0]['ip']}:${service['catalog.agent.http.port']}
catalog.diocles.server.address = ${service.roles["CATALOG_DIOCLES"][0]['ip']}:${service['catalog.diocles.http.port']}
...
catalog.es.username = ${service['catalog.es.username']?if_exists}
catalog.es.password = ${service['catalog.es.password']?if_exists}
...
baymax.web.server.address = https://${service.roles["BAYMAX_WEB"][0]['ip']}:${service['baymax.web.http.port']}
