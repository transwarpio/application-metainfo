...
<#if service.auth == "kerberos">
    ...
    <@property "hbase.regionserver.kerberos.principal" "hbase-os/_HOST@" + service.realm/>
    <@property "hbase.regionserver.keytab.file" service.keytab/>
    <@property "hbase.master.kerberos.principal" "hbase-os/_HOST@" + service.realm/>
    <@property "hbase.master.keytab.file" service.keytab/>
    <@property "hbase.thrift.kerberos.principal"  "hbase-os/_HOST@" + service.realm/>
    <@property "hbase.thrift.keytab.file" service.keytab/>
    <@property "hbase.thrift.security.qop" "auth-conf"/>
    <@property "hbase.rest.kerberos.principal" "hbase-os/_HOST@" + service.realm/>
    <@property "hbase.rest.keytab.file" service.keytab/>
    <@property "hbase.rest.authentication.kerberos.principal" "hbase-os/_HOST@" + service.realm/>
    <@property "hbase.rest.authentication.kerberos.keytab" service.keytab/>
    <@property "hbase.security.authorization" "true"/>
    <@property "hbase.coprocessor.region.classes" "org.apache.hadoop.hbase.security.token.TokenProvider,org.apache.hadoop.hbase.security.access.AccessController,org.apache.hadoop.hbase.security.access.SecureBulkLoadEndpoint"/>
    <@property "hbase.coprocessor.master.classes" "org.apache.hadoop.hbase.security.access.AccessController"/>
</#if>
