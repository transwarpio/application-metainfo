...
<@property "tdt.ssl.key.store" "/srv/${service.sid}/server.keystore"/>
<@property "tdt.ssl.key.store.password" "changeit"/>
<@property "tdt.ssl.key.store.type" "JKS"/>
...
<#if dependencies.ZOOKEEPER??>
 ...
 <@property "tdt.zookeeper.quorum" quorums?join(",")/>
</#if>
