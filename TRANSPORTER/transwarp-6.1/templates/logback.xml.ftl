...
<configuration debug="true">
    ...
    <appender name="ROLLING" class="ch.qos.logback.core.rolling.RollingFileAppender">
        <file>${TDT_LOG_DIR:-/var/log/${service.id}}/tdt.log</file>
        <rollingPolicy class="ch.qos.logback.core.rolling.SizeAndTimeBasedRollingPolicy">
            <!-- daily rollover -->
            <fileNamePattern>${TDT_LOG_DIR:-/var/log/${service.id}}/tdt_%d{yyyyMMdd}.%i.log</fileNamePattern>
    ...
    <appender name="SIFT" class="ch.qos.logback.classic.sift.SiftingAppender">
        ...
        <sift>
            <appender name="File-${jobNodeLog}" class="ch.qos.logback.core.FileAppender">
                <file>${TDT_LOG_DIR:-/var/log/${service.id}}/${jobNodeLog}</file>
                <append>true</append>
                <encoder charset="UTF-8">
                    <pattern>[%d{yyyy-MM-dd HH:mm:ss.SSS}] %-5level %logger{35} - %msg%n</pattern>
                </encoder>
    ...
    <logger name="com.alibaba.otter.canal.server.netty" level="WARN"/>
    ...
    <logger name="io.transwarp.transporter.canal" level="INFO">
        <appender-ref ref="SIFT"/>
    </logger>
