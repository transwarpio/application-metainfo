...
sources:
- name: kundb_kuntablet_rdonly_debug_var_source
  className: io.transwarp.tdh.metrics.source.HttpJsonSource
  props:
    url: "http://${localhostname}:${service['rdonly.debug.port']}/debug/vars"
    timeoutSec: 60
    cacheSec: 60

metrics:
- name: kundb_kuntablet_rdonly_transactions_sum_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
  ...
  delaySec: 61
  source: kundb_kuntablet_rdonly_debug_var_source
  scrape: 
    jsonPath: "$.Transactions"
    valueField: "TotalCount"
    fromResultLabelMap: {}

- name: kundb_kuntablet_rdonly_kills_transactions_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_kills_queries_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_internalErrors_panic_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_internalErrors_hungQuery_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_internalErrors_twopcCommit_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_internalErrors_twopcResurrection_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_internalErrors_watchdogFail_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_internalErrors_schema_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_invalidArgument_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_outOfRange_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_alreadyExists_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_unauthenticated_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_permissionDenied_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_aborted_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_deadlineExceeded_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_resourceExhausted_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
...
- name: kundb_kuntablet_rdonly_errors_unknown_total
  fixedLabels:
    <@serviceLabel/>
    <@roleLabel/>
  type: COUNTER
